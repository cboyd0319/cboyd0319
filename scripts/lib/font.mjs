...
const CSS_URL = "https://fonts.googleapis.com/css2?family=Share+Tech+Mono&display=swap";
const FONT_URL_RE = /url\((https:\/\/fonts\.gstatic\.com\/[^)]+)\)/;

/**
 * Fetches Share Tech Mono from Google Fonts and returns it as a base64 data URL
